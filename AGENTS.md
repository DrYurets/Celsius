...
- Верхняя строка (как на `128x128`): weekday → дата → indoor T/RH → иконка OTA → батарея (без домика / без нижней строки).
- Время HH:MM (`logisoso28`) слева; при наличии погоды справа — иконка WMO, outdoor T и PoP (PoP скрывается при 0%).

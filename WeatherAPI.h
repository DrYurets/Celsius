...
RTC_DATA_ATTR bool lastNetworkNtpOk = true;   // для короткого интервала повтора при ошибке NTP
...
// Интервал NTP + погоды в активном (дневном) режиме, updateHours — из админки (1..24 ч).
